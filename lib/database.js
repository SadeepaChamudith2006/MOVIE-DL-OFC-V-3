...
LOGO: "https://raw.githubusercontent.com/DarkYasiyaofc/FROZEN-HARD/main/IMAGES/movie-x.jpg",
FILE_NAME: "🎬 DARKYASIYAXTEAM 🎬",
FOOTER: "𝗠 𝗢 𝗩 𝗜 𝗘 - 𝗫",
CAPTION: "*ᴍᴏᴠɪᴇ ᴜᴘʟᴏᴀᴅ ʙʏ ᴍᴏᴠɪᴇ-x ᴡᴀ ʙᴏᴛ*\n*ᴘᴏᴡᴇʀᴇᴅ ʙʏ • ᴅᴀʀᴋʏᴀsɪʏᴀxᴛᴇᴀᴍ*",
...
config.LOGO = "https://raw.githubusercontent.com/DarkYasiyaofc/FROZEN-HARD/main/IMAGES/movie-x.jpg"
config.FILE_NAME = ""
config.FOOTER = "*ᴍᴏᴠɪᴇ ᴜᴘʟᴏᴀᴅ ʙʏ ᴍᴏᴠɪᴇ-x ᴡᴀ ʙᴏᴛ*\n*ᴘᴏᴡᴇʀᴇᴅ ʙʏ • ᴅᴀʀᴋʏᴀsɪʏᴀxᴛᴇᴀᴍ*",
config.CAPTION = "> ©𝗗 𝗔 𝗥 𝗞 𝗬 𝗔 𝗦 𝗜 𝗬 𝗔 𝗫 𝗧 𝗘 𝗔 𝗠"
config.BODY = "ᴘᴏᴡᴇʀᴇᴅ ʙʏ • ᴅᴀʀᴋʏᴀꜱɪʏᴀxᴛᴇᴀᴍ"
config.MAX_SIZE = 500
config.MAX_SIZE_GB = 1.5
config.SUDO_NUMBER = "94743548986"
config.OWNER_REACT_EMOJI = `👾`
config.OWNER_REACT = "true"
config.CINE_BLOCK = "false"
config.OWNER_NUMBER = "94743548986"
